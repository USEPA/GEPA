...
# from a_excel_dict import (read_excel_dict, file_path)
...
def get_coal_inv_data(input_path, output_path, subcategory):
    ...
    subcategory_strings = read_excel_dict2(file_path, sheet="Testing")
...
#    }
    ...
    emi_df = (
        ...
        pd.read_excel(
            ...
            usecols=subcategory_strings["arguments"][3]  # A:BA
        )
...
# %%
subcategory_strings = read_excel_dict2(file_path, sheet="Testing")
type(subcategory_strings["arguments"][1])

if type(subcategory_strings["arguments"][1]) == float:
    subcategory_strings["arguments"][1] = int(subcategory_strings["arguments"][1])
