"""
Name:                   pet_pneum_dev_emis.py
Date Last Modified:     2024-07-25
Authors Name:           A. Burnette (RTI International)
Purpose:                Mapping of petroleum pneumatic devices - mobile emissions to
                        State, Year,
                        emissions format
Input Files:            - PneumaticControllers_StateEstimates_2024.xlsx
...
def get_pet_pneum_dev_inv_data(input_path, output_path):
    """
