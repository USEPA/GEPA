...
v3_v3_emi_data_dir_path = V3_DATA_PATH / "emis"
...
def load_global_file_names():
    ...
    return (
        State_ANSI_inputfile,
        County_ANSI_inputfile,
        pop_map_inputfile,
        Grid_area01_inputfile,
        Grid_area001_inputfile,
        Grid_state001_ansi_inputfile,
...
def load_area_map_001(Grid_area001_inputfile):
    ...
    area_map001[area_map001 > 1.0e14] = 0
...
def load_state_ansi(state_ansi_inputfile):
    ...
    State_ANSI = pd.read_csv(
        state_ansi_inputfile, skiprows=1, sep="|", thousands=",", usecols=[0, 1, 2]
    )
