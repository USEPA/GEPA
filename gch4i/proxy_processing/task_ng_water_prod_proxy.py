...
Input Files:            State Geo: global_data_dir_path / "tl_2020_us_state.zip"
                        ...
                        Emissions: emi_data_dir_path / "ng_prod_water_emi.csv"
Output Files:           basin Other: proxy_data_dir_path / "ng_water_prod_proxy.parquet"
"""
...
def task_get_ng_water_prod_proxy_data(
    ...
    ng_prod_water_emi_path: Path = emi_data_dir_path / "ng_prod_water_emi.csv",
