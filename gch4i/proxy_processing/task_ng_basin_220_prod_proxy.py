...
Input Files:            State Geo: global_data_dir_path / "tl_2020_us_state.zip"
                        ...
                        Emissions: emi_data_dir_path / "basin_220_emi.csv"
Output Files:           basin 220: proxy_data_dir_path / "ng_basin_220_prod_proxy.parquet"
"""
...
def task_get_ng_basin_220_prod_proxy_data(
    ...
    basin_220_emi_path: Path = emi_data_dir_path / "basin_220_emi.csv",
    ...
    *IL and IN do not report to Enverus, but do have oil and gas production. Production
    ...
    Details: ERG does not include a well in the national count if there is no
        (cummulative) oil or gas production from that well.
    ...
    Well Type (e.g., non-associated oil well) is determined based on annual production
        ...
        included in maps in months where monthly ng prod > 0"
    """
