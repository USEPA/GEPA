"""
Name:                   task_ng_hf_well_count_proxy.py
Date Last Modified:     2025-01-30
Authors Name:           Hannah Lohman (RTI International)
Purpose:                Mapping of natural gas HF well count proxy emissions.
Input Files:            State Geo: global_data_dir_path / "tl_2020_us_state.zip"
                        ...
                        Emissions: emi_data_dir_path / "non_assoc_hf_emi.csv"
Output Files:           proxy_data_dir_path / "ng_hf_well_count_proxy.parquet"
"""
...
def task_get_ng_hf_well_count_proxy_data(
    ...
    non_assoc_hf_emi_path: Path = emi_data_dir_path / "non_assoc_hf_emi.csv",
    ...
    *IL and IN do not report to Enverus, but do have oil and gas production. Production
    ...
    for iyear in years:
        ...
        for imonth in range(1,13):
            ...
            # HF Gas Well Count
            hf_well_count_imonth = (ng_data_imonth_temp[['year', 'month','year_month','STATE_CODE','LATITUDE','LONGITUDE','WELL_COUNT','HF']]
                                   .query("HF == 'Y'")
                                   .drop(columns=["HF"])
    ...
    emi_df = (pd.read_csv(non_assoc_hf_emi_path)
                          .query("state_code.isin(@state_gdf['state_code'])")
