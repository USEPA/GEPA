"""
Name:                  grassland_remaining_proxy.py
Date Last Modified:    2025-01-22
Authors Name:          Chris Coxen (RTI International)
Purpose:               Process remaining grassland proxy data for emissions.
Input Files:           - {emi_data_dir_path}/grassland_emi.csv
                       ...
                       - {proxy_data_dir_path}/fire/nawfd_fuelbed_Aug2023_jesModified
                        .csv
Output Files:          - {proxy_data_dir_path}/grassland_proxy.parquet
"""
...
grassland_proxy['fuelbed_aggregate'] = (
    grassland_proxy['fuelbed_aggregate'].str
...
# Filter the MTBS data to only include grassland hab types in the FCCS and NAWFD data
...
final_grassland_proxy_df.to_parquet(proxy_data_dir_path / "grassland_proxy.parquet",
                                    index=False)
