...
for _id, _kwargs in emi_parameters_dict.items():
    ...
    def task_composting_emi(
        ...
        """ Process composting emissions data from GHGI source files.

        Args:
            input_path (Path): Path to the GHGI source file.
            source_list (list): List of composting sources to filter the data.
            output_path (Path): Path to save the processed emissions data.
