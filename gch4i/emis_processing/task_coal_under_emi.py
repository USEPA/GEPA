...
def get_coal_under_inv_data(in_path, src, params):
    ...
    Function reads in the inventory data for coal underground mining and returns the
...
source_name = "1B1a_coal_mining_underground"
...
for _id, _kwargs in emi_parameters_dict.items():
    ...
    def task_coal_under_emi(
        ...
        for input_path, ghgi_group in zip(input_paths, source_list):
            individual_emi_df = get_coal_under_inv_data(input_path,
                                                        ghgi_group,
                                                        parameters)
