...
# %% Step 1. Function to read in the petrochemicals emissions data ---------------------


def get_petrochemicals_inv_data(in_path, src):
    """
...
source_name = "2B8_petrochemicals"
...
for _id, _kwargs in emi_parameters_dict.items():
    ...
    def task_petrochemicals_emi(
        ...
        for input_path, ghgi_group in zip(input_paths, source_list):
            individual_emi_df = get_petrochemicals_inv_data(input_path,
                                                            ghgi_group)
